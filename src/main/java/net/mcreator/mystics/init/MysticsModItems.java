...
import net.mcreator.mystics.item.WizardsStaffItem;
...
public class MysticsModItems {
	...
	public static final RegistryObject<Item> WIZARDS_STAFF = REGISTRY.register("wizards_staff", () -> new WizardsStaffItem());
