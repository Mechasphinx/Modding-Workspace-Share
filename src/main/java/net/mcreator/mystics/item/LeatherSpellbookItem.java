...
import net.mcreator.mystics.item.inventory.LeatherSpellbookInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class LeatherSpellbookItem extends Item implements ICurioItem {
	public LeatherSpellbookItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Leather Spellbook");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new LeatherguiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new LeatherSpellbookInventoryCapability();
	}
